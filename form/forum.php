...
body {
  ...
  align-items: center;
  min-height: 100vh;
  background: url("pic/home.jpg") no-repeat;
...
<body>
    ...
    <div style="text-align: center; margin-top: 5%">
        <button class="icon-btn add-btn" style="position: relative; left: 1px;" onclick="redirectToForum()">
